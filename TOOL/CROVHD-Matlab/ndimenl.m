...
function distribution = ndimenl(dimen,points,intervalLen,extra,flag,handles,outputpath)%handles.plotFlag,baxes)
...
if handles.plotFlag
    visualise(distribution,intervalLen,str,handles.colorDist,outputpath);
else
    visualiseScatter(distribution,intervalLen,str,handles.baseAxes,handles.colorDist,outputpath);
end
end
%*************************************************************************
