...
% Draws scatter plots
%**************************************************************************
function visualiseScatter(dist,intervalLen,str,refdimen,colorDist,outputpath)
    ...
    %saveas(f,outputpath,'fig')
    print(outputpath,'-dpng')
    %print('static/output/myplot','-dpng')
    end